...
acs <- rbind(read_fwf(here("data","data_raw","acs1418","usa_00106.dat.gz"),
                      col_positions = fwf_positions(start = acs_start,
                                                    end   = acs_end,
                                                    col_names = acs_names),
                      col_types = cols(.default = "i"), 
                      progress = FALSE),
             read_fwf(here("data","data_raw","acs1418","usa_00107.dat.gz"),
                      col_positions = fwf_positions(start = acs_start,
                                                    end   = acs_end,
                                                    col_names = acs_names),
                      col_types = cols(.default = "i"), 
                      progress = FALSE),
             read_fwf(here("data","data_raw","acs1418","usa_00108.dat.gz"),
                      col_positions = fwf_positions(start = acs_start,
                                                    end   = acs_end,
                                                    col_names = acs_names),
                      col_types = cols(.default = "i"), 
