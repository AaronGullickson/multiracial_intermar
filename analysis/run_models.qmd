...
I move the running of the models to a dedicated script because they can take a long time to run. Lets start with a timestamp.
...
mar_market <- add_vars(mar_market)
```
...
formula_base <- formula(choice~race_exog+
                          ...
                          strata(group))
model <- clogit(formula_base, data=mar_market, method="efron")
