...
# full racial exogamy
formula_full_sym <- update(formula_base, .~.+race_exog_full_sym)


# constrained racial exogamy
formula_short_sym <- update(formula_base, .~.+race_exog_short_sym+
                              multi_shared_ancestry)

# constrained but asymmetric racial exogamy
formula_short_asym <- update(formula_base, .~.+race_exog_short_asym+
                               multi_shared_ancestry)
```
