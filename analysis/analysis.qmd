...
```{r}
#| label: fig-odds-ratios-latino2
#| fig-cap: Odds of interracial marriage across all monoracial groups. 83.4% and 95% confidence intervals are shown for each estimate with thick and thin bars, respectively.
