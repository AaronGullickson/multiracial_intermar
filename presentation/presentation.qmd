...
## New Eve and the Mulatto Vanguard

- The ever present hope that mixing will usher in a post-racial future

## The Biracial Focus

- Focus on the experience of "first generation" biracial individuals masks the complexity of the future (and present)
...
## Who do Multiracial Individuals Marry?
...
## Distribution of Partner Race for Multiracial Spouses
...
plot_partner_choice <- partner_choice |>
  ...
  count(race_ego, race_spouse) |>
  group_by(race_ego) |>
  mutate(prop = n / sum(n)) |>
  ungroup() |>
  mutate(race_ego = as.character(race_ego),
